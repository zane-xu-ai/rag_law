...
- [test_constitution_md_golden.py](../../tests/test_chunking/test_constitution_md_golden.py)：**完整** [data/宪法.md](../../data/宪法.md) 在 `1500/100`、句边界与 `boundary_priority_overlap` 与预览一致时的 **切分区间黄金回归**（数据见 [fixtures/宪法_1500_100_boundary_golden.json](../../tests/test_chunking/fixtures/宪法_1500_100_boundary_golden.json)）。
