...
| **路线状态** | **方案 C**：离线导出（`c03_breakpoint`），**未**进主入库链。**方案 D**：离线导出（`d04_document_segmentation`，见 v1.1.9），主链路未接；入库主线见 [v1.0.4-ingest-plan.md §12](v1.0.4-ingest-plan.md)。 |
...
> **状态：离线导出已可用（d04），主链路未接。** 详见 [v1.1.9-scheme-d-concrete.md](v1.1.9-scheme-d-concrete.md)。
...
| §3 方案 D | **离线导出已落地**（[`scripts/d04_document_segmentation_export.py`](../../scripts/d04_document_segmentation_export.py)、[`chunking/document_segmentation.py`](../../src/chunking/document_segmentation.py)）；主入库链未接；评测见 [v1.1.8-scheme-d-eval.md](v1.1.8-scheme-d-eval.md)，说明见 [v1.1.9-scheme-d-concrete.md](v1.1.9-scheme-d-concrete.md) |
